...
<script type="text/html" id="notebook-actions">
  <div class="btn-group">
    ...
    <a class="btn red" rel="tooltip" data-placement="bottom" title="${ _("Stop all") }" data-bind="visible: $root.selectedNotebook() && $root.selectedNotebook().isExecutingAll(), click: function() { $root.selectedNotebook().isExecutingAll(false); }">
